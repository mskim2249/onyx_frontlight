...
public class MyShortcut2 extends Activity {
    ...
    public void onCreate(Bundle icicle){
        ...
        if (FrontLightController.hasCTMBrightness(this)) {
            FrontLightController.decreaseBrightness(this, FrontLightController.LIGHT_TYPE_CTM_WARM);
            FrontLightController.decreaseBrightness(this, FrontLightController.LIGHT_TYPE_CTM_COLD);
        } else if (FrontLightController.hasFLBrightness(this)) {
            FrontLightController.decreaseBrightness(this, FrontLightController.LIGHT_TYPE_FL);
        }
        finish();
    ...
    private void setupShortcut() {
        ...
        intent.putExtra(Intent.EXTRA_SHORTCUT_NAME, getString(R.string.long_shortcut_2)); //shortcut 명 지정
        Intent.ShortcutIconResource iconResource = Intent.ShortcutIconResource.fromContext(
                this,  R.drawable.vector_2);
